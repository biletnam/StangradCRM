...
{
	/// <summary>
	/// Interaction logic for ManagerBidControlID1.xaml
	/// </summary>
	public partial class ManagerBidControlID1 : UserControl
	{
		...
		{
			InitializeComponent();
			ManagerBidControlID1.viewSource = viewSource;
			ManagerBidControlID1.viewSource.SortDescriptions.Add(new SortDescription("Date_created", ListSortDirection.Descending));
			DataContext = new
			{
				BidCollection = ManagerBidControlID1.viewSource.View
			};
		}

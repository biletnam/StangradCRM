...
{
	/// <summary>
	/// Interaction logic for MainControlMyBid.xaml
	/// </summary>
	public partial class MainControlMyBid : UserControl
	{
		public MainControlMyBid()
		{
			InitializeComponent();
			...
			for(int i = 0; i < bidStatus.Count; i++)
			{
				try
				{
					...
					tabItem.Content = View.Helpers.DirectorMyBidControlHelper.GetControl(bidStatus[i].Id);
				}
				catch(Exception ex)
				{

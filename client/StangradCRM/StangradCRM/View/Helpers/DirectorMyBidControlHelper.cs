...
{
	/// <summary>
	/// Description of DirectorMyBidControlHelper.
	/// </summary>
	public static class DirectorMyBidControlHelper
	{
		...
		public static UserControl GetControl (int bidStatusId)
		{
			...
			{
					case 1:		
						control = new MyBidControlID1(viewSource);
						break;
					case 2:
						control = new MyBidControlID2(viewSource);
						break;
					default:
